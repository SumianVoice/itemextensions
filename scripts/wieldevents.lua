...
function itemextensions.wield.register_on_select(func)
    registers[1][#registers[1]+1] = func
end
-- functionct(stack, player) ==> nil | itemstack
function itemextensions.wield.register_on_deselect(func)
    registers[2][#registers[1]+1] = func
end
-- function(stack, player, dtime) ==> nil | itemstack
function itemextensions.wield.register_on_step(func)
